...
def add_optional_parameters_sans(detail_json, rating, rating_n, popularity, current_popularity, time_spent):
    """
    check for optional return parameters and add them to the result json
    :param detail_json:
    :param rating:
...
def get_populartimes_from_search(place_identifier):
    ...
    # detail_json = add_optional_parameters_sans(detail_json, rating, rating_n, popular_times, current_popularity, time_spent )

    # return detail_json
    return rating, rating_n, popular_times, current_popularity, time_spent

def get_populartimes_from_search_spl(place_identifier, detail_json):
    """
    request information for a place and parse current popularity
    :param place_identifier: name and address string
    :return:
...
def get_populartimes(api_key, place_id , name, address):
    """
    ...
    return get_populartimes_from_search_spl(place_identifier, detail_json)
